      ...
      <el-table :data="articles">
        <el-table-column label="封面">
          <template slot-scope="scope">
            <el-image fit="cover" :src="scope.row.cover.images[0]" style="width:120px;height:80px">
              <div slot="error">
...
export default {
  ...
  methods: {
    ...
    // 筛选函数
    search () {
      // 筛选项都是双向绑定  拿着对应的数据发请求即可  注意重新筛选后页码为第一页
